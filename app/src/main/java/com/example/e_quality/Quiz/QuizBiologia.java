...
public class QuizBiologia extends AppCompatActivity {
    ...
    private String id [] = {"19", "20", "21", "22", "23", "24", "25", "26", "27"};
    ...
    public void selectInsert() {
        ...
        else if (intValue == R.id.quizB2){
            insertQuiz2();
        }
        else if (intValue == R.id.quizB3){
            insertQuiz3();
        }
    }
    ...
    private void insertQuiz1 (){
        ...
        int[] toViews1 = new int[]{id_questions[0], id_label_question[0], id_answers[2], id_answers[1], id_answers[0]};
    ...
    private void insertQuiz2 (){
        ...
        String[] fromColumns3 = new String[]{QuizSQLite.COL_QUESTION, QuizSQLite.COL_TOPIC, QuizSQLite.COL_CORRECT_ANSWER, QuizSQLite.COL_INCORRECT_ANSWER1, QuizSQLite.COL_INCORRECT_ANSWER2};
        int[] toViews3 = new int[]{id_questions[2], id_label_question[2], id_answers[8], id_answers[7], id_answers[6]};
        SimpleCursorAdapter putQuestions3 = new SimpleCursorAdapter(this, R.layout.quiz3, getQuestion3, fromColumns3, toViews3, 0);
        listView3.setAdapter(putQuestions3);
    }
    ...
    public void clickCheckAnswers (View view){
        ...
        if (intValue == R.id.quizB1){
            ...
            scoresSQLite.insertPoints(finalScore, "7");
            endDate1 = new Date();
            calculateQuizTime("7", endDate1);
        }
            ...
            finalScore = Integer.toString(score1 + score2 + score3);
            scoresSQLite.insertPoints(finalScore, "8");
            endDate2 = new Date();
            calculateQuizTime("8", endDate2);
        }
            ...
            finalScore = Integer.toString(score1 + score2 + score3);
            scoresSQLite.insertPoints(finalScore, "9");
            endDate3 = new Date();
            calculateQuizTime("9", endDate3);
        }
        ...
        if ((isCorrect[0] == true) && (isCorrect[1] == true) && (isCorrect[2] == true)) {
            ...
            Toast.makeText(QuizBiologia.this, result, Toast.LENGTH_LONG).show();
