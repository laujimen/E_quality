...
public class QuizQuimica extends AppCompatActivity {
    ...
    private String id [] = {"10", "11", "12", "13", "14", "15", "16", "17", "18"};
    ...
    public void selectInsert() {
        ...
        else if (intValue == R.id.quizQ2){
            insertQuiz2();
        }
        else if (intValue == R.id.quizQ3){
            insertQuiz3();
        }
    }
    ...
    public void clickCheckAnswers (View view){
        ...
        if (intValue == R.id.quizQ1){
            ...
            scoresSQLite.insertPoints(finalScore,"4");
            endDate1 = new Date();
            calculateQuizTime("4", endDate1);
        }
        ...
        if (intValue == R.id.quizQ2){
            ...
            finalScore = Integer.toString(score1 + score2 + score3);
            scoresSQLite.insertPoints(finalScore,"5");
            endDate2 = new Date();
            calculateQuizTime("5", endDate2);
        }
            ...
            finalScore = Integer.toString(score1 + score2 + score3);
            scoresSQLite.insertPoints(finalScore,"6");
            endDate3 = new Date();
            calculateQuizTime("6", endDate3);
        }
        ...
        if ((isCorrect[0] == true) && (isCorrect[1] == true) && (isCorrect[2] == true)) {
            ...
            Toast.makeText(QuizQuimica.this, result, Toast.LENGTH_LONG).show();
